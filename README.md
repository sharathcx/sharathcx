...
### **Unmask**  
An award-winning project that distinguishes real from manipulated visual content using AI-powered deepfake detection and **blockchain certification** for authenticity as NFTs.  
...
- 🏆 **HackOnBlocks - Unmask Project:**  
  Secured **3rd Prize** and $1000 award for **Best MVP of Polygon Cardano**, showcasing excellence in integrating AI and blockchain.  
